...
import { usePostDeviceInspectionMutation } from "../data/queryOptions";
...
export const InspectionDefault: IInspectionDevices[] = [
    {
        srNo: 1,
        deviceName: "",
        imeiNumber: "",
...
const DeviceInspectionAddForm: React.FC<DeviceInspectionInterface> = ({ isOpen, onClose }) => {
    const [parentId, setParentId] = useState<string>("");
    const [divisionName, setDivisionName] = useState<string>("");
    const [reportDate, setReportDate] = useState<Date | null>(new Date());
    const [devicesInspectionList, setDevicesInspectionList] = useState<IInspectionDevices[]>(InspectionDefault);

    const { mutate, isPending } = usePostDeviceInspectionMutation();
    ...
    return (
        <ChakraUiModal isOpen={isOpen} modalSize="7xl" scroll onClose={onClose} modalHeader="Add Inspection Report">
                            ...
                            {devicesInspectionList.length === 0 && (
                                <tr>
                                    <td colSpan={9} className="py-12 text-center text-gray-400 text-sm">
                                        No devices added. Click "Add Device" to begin.
                                    </td>
                                </tr>
                            )}
                        </tbody>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-200">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button
                            ...
                            className="!bg-green-600 hover:!bg-green-700 !text-white !rounded-lg !px-8 !font-semibold"
                        >
                            Submit Report
                        </Button>
                    </div>
...
export default DeviceInspectionAddForm;
